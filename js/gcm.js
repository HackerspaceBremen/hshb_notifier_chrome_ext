 ...
 */
GCM.prototype.log = function(message, data) {
  if (data) {
...
/**
 * Returns a callback bound to the GCM object.  The
 * callback must be an attribute of the GCM object.
 *
 * @this GCM
 ...
 */
GCM.prototype.cb = function(eventName, otherArgs) {
  var bindArgs = [this];
 ...
 * @this GCM
 */
GCM.prototype.initialize = function() {
  this.startListening();
 ...
 * @this GCM
 */
GCM.prototype.onReady = function() {
 ...
 */
GCM.prototype.onGotChannelId = function(message) {
 ...
 */
GCM.prototype.onGCMEntry = function(message) {
  // TODO throw notification and change icon
 ...
 * @param {Object} message The payload sent from the server.
 */
GCM.prototype.onSubscriptionVerification = function(message) {
...
/**
 * Notifies Chrome to start sending messages to this GCM
 *
 * @this GCM
 */
GCM.prototype.startListening = function() {
...
/**
 * Notifies Chrome to stop sending messages to this GCM
 *
 * @this GCM
 */
GCM.prototype.stopListening = function() {
 ...
 */
GCM.prototype.onXHR = function(xhrEvent) {
 ...
 */
GCM.prototype.sendVerificationMessage = function(verifier) {
  this.tellServer({
 ...
 */
GCM.prototype.tellServer = function(params) {
  var xhr = new XMLHttpRequest();

  this.log('Notifying the server');
  // TODO use own server instead
  xhr.open('POST', 'https://testhackerspacehb.appspot.com/gcm'); // ??? not sure if this is the right one
 ...
 */
GCM.prototype.unsubscribe = function() { };
 ...
 * @this GCM
 */
GCM.prototype.onWindowClosed = function() {
 ...
 * the window object within the GCM object.
 *
 * @this GCM
 * @param {Object} theWindow the window object that was created.
 */
GCM.prototype.onWindowCreated = function(theWindow) {
 ...
 * @this GCM
 */
GCM.prototype.onLaunched = function() {
